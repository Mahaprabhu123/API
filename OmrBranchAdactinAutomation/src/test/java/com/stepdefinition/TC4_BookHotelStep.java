...
public class TC4_BookHotelStep {
	...
	@Then("User should verify after booking hotel success message {string}")
	public void userShouldVerifyAfterBookingHotelSuccessMessage(String string) {
	...
	public void userShouldClickBookNowWithoutEnterAnyFiedls() {
	...
	public void userShouldVerifyWithoutEnterAnyFieldsWhileBookingErrorMessageAnd(String string, String string2, String string3, String string4, String string5, String string6, String string7) {
